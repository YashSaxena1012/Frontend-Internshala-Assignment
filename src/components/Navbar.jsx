...
//   return (
//     <header className="container mx-auto py-8 scroll-smooth w-full">
//       <nav className="flex justify-center items-center py-8">
//         <ul className="hidden md:flex gap-20 z-40">
...
//                 ""
//               ) : id === 7 ? (
//                 <button className="bg-orange-700 cursor-pointer hover:bg-orange-600 text-white font-bold py-1 px-2 rounded-full duration-300">
//                   {title}
//                 </button>
//               ) : (
//                 <>
//                   <h2 className="hover:text-orange-500 whitespace-nowrap cursor-pointer">
//                     {title}
//                   </h2>
//                   {dropdown && dropdownIndex === id && (
//                     <div className="flex flex-col whitespace-nowrap absolute top-full left-0 bg-white font-semibold shadow-md py-2 px-4 opacity-90 items-start">
//                       {dropdown.map((item) => (
...
//                 <h2
//                   className="hover:text-gray-300 text-5xl"
...
const Navbar = () => {
  ...
  return (
    ...
    <div className="container m-auto py-8 scroll-smooth max-w-max">
      <nav className="flex justify-center items-center py-8 sm:sticky top-0 z-50 sm:bg-white font-libre">
        <ul className="hidden md:flex gap-20 md:gap-7 lg:gap-10 xl:gap-12 z-40 font-Montserrat ">
          {navItems.map(({ id, title, dropdown }) => (
            <li
              key={id}
              className="text-base text-primary relative"
