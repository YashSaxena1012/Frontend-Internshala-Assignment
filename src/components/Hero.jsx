...
const Hero = () => {
  return (
        <div className="flex justify-center items-center relative max-w-max">
          <video className="video opacity-80" autoPlay loop poster="https://24carrots.com/wp-content/uploads/2023/08/chef.png">
